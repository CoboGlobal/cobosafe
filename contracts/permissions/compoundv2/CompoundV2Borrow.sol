...
contract CompoundV2Borrow is BasePermission, BaseTokenSetter {
    bytes32 public constant NAME = "CompoundV2Borrow";
    ...
    function borrow(uint borrowAmount) external pure {}
}
