...
contract BaseCompoundUsdcDepositor is BaseCompoundAuthorizer {
    bytes32 public constant NAME = "BaseCompoundUsdcDepositor"; //
    ...
    function supply(address asset, uint amount) external view nonPayable onlycUSDbCv3 {
